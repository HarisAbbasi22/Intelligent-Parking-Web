...
const VisitorParkers = React.lazy(() => import('./views/parkers/VisitorParkers'));
...
const routes = [
  ...
  { path: '/parkers/visitor-parkers', name: 'Visitor Parkers', component: VisitorParkers },
  { path: '/parkers/season-parkers', name: 'Season Parkers', component: SeasonParkers },
